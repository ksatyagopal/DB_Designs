...
CREATE TABLE Products(
	...
	ProductID as cast('product'+cast(ID as varchar) as varchar(20)) persisted PRIMARY KEY,
...
CREATE TABLE Offers(
	ID int IDENTITY(100,1),
	OfferID as cast('offer'+cast(ID as varchar) as varchar(20)) persisted PRIMARY KEY,
...
CREATE TABLE Users(
	...
	UserID as cast('user'+cast(ID as varchar) as varchar(20)) persisted PRIMARY KEY,
...
CREATE TABLE Orders(
	...
	OrderID as cast('order'+cast(ID as varchar) as varchar(20)) persisted PRIMARY KEY,
	UserID varchar(20) FOREIGN KEY REFERENCES Users(UserID),
	DistinctItems int,
	TotalAmount float,
...
CREATE TABLE PaymentDetails(
	...
	PaymentID as cast('payment'+cast(ID as varchar) as varchar(20)) persisted PRIMARY KEY,
	Amount float,
	[Provider] varchar(50),
	PaymentStatus bit,
	IsPending bit,
